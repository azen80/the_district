<?php include('header.php'); ?>
      ...
      <div class="row g-0">
        ...
        <div class="col-md-8">
          <div class="card-body">
            ...
            <button class = "btn btn-primary btn-xs position-absolute bottom-0 end-0 mb-3 me-3" id="commander">Commander</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="rowplats">
    <div class="card mb-3 burger-card visible" style="max-width: 800px;">
      <div class="row g-0">
        <div class="col-md-4">
          <img src="./assets/images/burger tex-mex.jpg" class="img-fluid rounded-start" style="height:332.47px;object-fit: cover; object-position: 15%;" alt="...">
        </div>
        <div class="col-md-8">
          <div class="card-body">
